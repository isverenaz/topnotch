            ...
            <div class="col-12">
                <div class="panel">
                    <div class="panel-header">
                        <h2>@lang('admin.universities')</h2>
                        @can('universities-create')
                            <a class="btn btn-sm btn-primary" href="{{ route('admin.universities.create') }}">
                    ...
                    <div class="panel-body">
                        <div class="row" id="sortable">
                            @if(!empty($universities[0]) && isset($universities[0]))
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                @can('universities-edit')
                                                    <a href="{{ route('admin.universities.edit',$data['id']) }}" class="btn btn-sm btn-icon btn-primary" title="@lang('admin.edit')">
                                            ...
                                            <div class="card-body animation-card">
                                                <div class="text-center" data-aos="flip-left">
                                                    <img src="{{ asset('uploads/universities/'.$data->image) }}" alt="{{ !empty($data['name'][$currentLang])? $data['name'][$currentLang]: null }}">
                                                </div>
                                            </div>
                                            @endif
                                        </div>
                ...
                <div class="modal fade" id="deleteMain{{$value['id']}}" tabindex="-1" aria-labelledby="deleteMain{{$value['id']}}Label" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('admin.universities.destroy',$value['id']) }}" method="POST">
                                @csrf
                                @method('DELETE')
