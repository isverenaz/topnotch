                                        ...
                                        <div class="tab-pane @if(++$key ==1) active @endif" id="{{$lang['code']}}"
                                            ...
                                            <div class="row g-3">
                                                <div class="col-12">
                                                    ...
                                                    <input type="text" class="form-control" name="name[{{$lang['code']}}]" value="{{ $university['name'][$lang['code']] ?? NULL }}">
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                                    ...
                                    <div class="row g-3">
                                            ...
                                            <select class="form-control" name="country_id">
                                                ...
                                                @if(!empty($countries[0]))
                                                    @foreach($countries as $country)
                                                        <option value="{{$country['id']}}" @if($country['id'] == $university['country_id']) selected="selected" @endif>{{$country['name'][$currentLang]}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                        <div class="col-sm-12">
                                            ...
                                            <select class="form-control" name="status">
                                                <option value="1" @if($university['status'] ==1) selected @endif>@lang('admin.active')</option>
                                                <option value="0" @if($university['status'] ==0) selected @endif>@lang('admin.nonactive')</option>
                                            </select>
                                        </div>
                                        <div class="col-sm-12">
                                            <label class="form-label">@lang('admin.is_main')</label>
                                            <select class="form-control" name="is_main">
                                                <option value="1" @if($university['is_main'] ==1) selected @endif>@lang('admin.active')</option>
                                                <option value="0" @if($university['is_main'] ==0) selected @endif>@lang('admin.nonactive')</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="col-md-5">
                                                <img src="{{ asset('uploads/universities/'.$university->image) }}" style="width: 288px;!important;">
                                            </div>
                                            @endif
                                        </div>
                                    </div>
