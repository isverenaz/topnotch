            ...
            <div class="col-12">
                <div class="panel">
                    <div class="panel-header">
                        <h2>@lang('admin.teachers')</h2>
                        @can('teachers-create')
                            <a class="btn btn-sm btn-primary" href="{{ route('admin.teachers.create') }}">
                    ...
                    <div class="panel-body">
                        <div class="row" id="sortable">
                            @if(!empty($teachers[0]) && isset($teachers[0]))
                                    ...
                                    <div class="col-sm-6" data-id="{{ $data['id'] }}">
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                @can('teachers-edit')
                                                    <a href="{{ route('admin.teachers.edit',$data['id']) }}" class="btn btn-sm btn-icon btn-primary" title="@lang('admin.edit')">
                                            ...
                                            <div class="card-body animation-card">
                                                <div class="text-center" data-aos="flip-left">
                                                    <img src="{{ asset('uploads/teachers/'.$data->image) }}" alt="{{ !empty($data['name'][$currentLang])? $data['name'][$currentLang]: null }}">
                                                </div>
                                            </div>
                                            @endif
                                        </div>
                ...
                <div class="modal fade" id="deleteMain{{$value['id']}}" tabindex="-1" aria-labelledby="deleteMain{{$value['id']}}Label" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('admin.teachers.destroy',$value['id']) }}" method="POST">
                                @csrf
                                @method('DELETE')
