...
@section('admin.content')
    <div class="main-content">
        ...
        <div class="row">
            <div class="col-12">
                <form action="{{ route('admin.educational-degrees.update',$educationalDegree['id']) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="panel">
                                        ...
                                        <div class="tab-pane @if(++$key ==1) active @endif" id="{{$lang['code']}}"
                                            ...
                                            <div class="row g-3">
                                                <div class="col-12">
                                                    ...
                                                    <input type="text" class="form-control" name="name[{{$lang['code']}}]" value="{{ $educationalDegree['name'][$lang['code']] ?? NULL }}">
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                                    ...
                                    <div class="row g-3">
                                        <div class="col-sm-12">
                                            ...
                                            <select class="form-control" name="status">
                                                <option value="1" @if($educationalDegree['status'] ==1) selected @endif>@lang('admin.active')</option>
                                                <option value="0" @if($educationalDegree['status'] ==0) selected @endif>@lang('admin.nonactive')</option>
                                            </select>
                                        </div>
                                        <div class="col-sm-12">
                                            <label class="form-label">@lang('admin.is_main')</label>
                                            <select class="form-control" name="is_main">
                                                <option value="1" @if($educationalDegree['is_main'] ==1) selected @endif>@lang('admin.active')</option>
                                                <option value="0" @if($educationalDegree['is_main'] ==0) selected @endif>@lang('admin.nonactive')</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            @if(!empty($educationalDegree['image']))
                                            <div class="col-md-5">
                                                <img src="{{ asset('uploads/educationalDegrees/'.$educationalDegree->image) }}" style="width: 288px;!important;">
                                            </div>
                                            @endif
                                        </div>
                                    </div>
