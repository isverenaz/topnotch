                                    ...
                                    <div class="col-sm-6" data-id="{{ $data['id'] }}">
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                @can('countries-edit')
                                                    <a href="{{ route('admin.countries.edit',$data['id']) }}" class="btn btn-sm btn-icon btn-primary" title="@lang('admin.edit')">
                                            ...
                                            <div class="card-body animation-card">
                                                <div class="text-center" data-aos="flip-left">
                                                    <img src="{{ asset('uploads/countries/'.$data->image) }}" alt="{{ !empty($data['name'][$currentLang])? $data['name'][$currentLang]: null }}">
                                                </div>
                                            </div>
                                            @endif
                                        </div>
                ...
                <div class="modal fade" id="deleteMain{{$value['id']}}" tabindex="-1" aria-labelledby="deleteMain{{$value['id']}}Label" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('admin.countries.destroy',$value['id']) }}" method="POST">
                                @csrf
                                @method('DELETE')
