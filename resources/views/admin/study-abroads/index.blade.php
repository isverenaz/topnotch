            ...
            <div class="col-12">
                <div class="panel">
                    <div class="panel-body">
                        <div class="row">
                            @if(!empty($studyAbroads[0]) && isset($studyAbroads[0]))
                                @foreach($studyAbroads as $data)
                                    <div class="col-sm-6">
                                        <div class="card">
                                            ...
                                            <div class="card-body animation-card">
                                                <div class="text-center" data-aos="flip-left">
                                                    <img src="{{ asset('uploads/studyAbroads/'.$data->image) }}" alt="{{ !empty($data['name']['az'])? $data['name']['az']: $data['name']['az'] }}" style="max-height: 327px;!important;">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
