                                        ...
                                        <div class="tab-pane @if(++$key ==1) active @endif" id="{{$lang['code']}}"
                                            ...
                                            <div class="row g-3">
                                                <div class="col-12">
                                                    ...
                                                    <input type="text" class="form-control" name="name[{{$lang['code']}}]" value="{{ !empty($studyAbroad['name'][$lang['code']])? $studyAbroad['name'][$lang['code']]: NULL }}">
                                                </div>
                                                <div class="col-12">
                                                    <label class="form-label">@lang('admin.text') - {{$lang['code']}}</label>
                                                    <textarea class="form-control" type="text" name="text[{{$lang['code']}}]" >{{ !empty($studyAbroad['text'][$lang['code']])? $studyAbroad['text'][$lang['code']]: NULL }}</textarea>
                                                </div>
                                                <div class="col-12">
                                                    ...
                                                    <textarea class="editor form-control"
                                                              ...
                                                              name="full_text[{{$lang['code']}}]">{!! !empty($studyAbroad['full_text'][$lang['code']])? $studyAbroad['full_text'][$lang['code']]: NULL !!}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-12">
                                            ...
                                            <select class="form-control" name="degree_id" id="degree_id">
                                                ...
                                                @foreach($educationalDegree as $degree)
                                                    <option value="{{$degree->id}}" @if($studyAbroad->degree_id == $degree->id) selected="selected" @endif>{{ !empty($degree['name'][$currentLang])? $degree['name'][$currentLang]: null }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-md-12">
                                            ...
                                            <select class="form-control" name="country_id" id="country_id">
                                                ...
                                                @foreach($countries as $country)
                                                    <option value="{{$country->id}}" @if($studyAbroad->country_id == $country->id) selected="selected" @endif>{{ !empty($country['name'][$currentLang])? $country['name'][$currentLang]: null }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-md-12" id="university-wrapper">
                                            ...
                                            <select class="form-control" name="university_id" id="university_id">
                                                <option value="{{$studyAbroad->university_id}}">{{$studyAbroad['university']['name'][$currentLang]}}</option>
                                            </select>
                                        </div>
                                        <div class="col-sm-4">
                                            <label class="form-label">@lang('admin.status')</label>
                                            <select class="form-control" name="status">
                                                <option value="1" @if($studyAbroad['status'] ==1) selected @endif>@lang('admin.active')</option>
                                                <option value="0" @if($studyAbroad['status'] ==0) selected @endif>@lang('admin.nonactive')</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-control" name="is_main">
                                                <option value="1" @if($studyAbroad['is_main'] ==1) selected @endif>@lang('admin.show')</option>
                                                <option value="0" @if($studyAbroad['is_main'] ==0) selected @endif>@lang('admin.nonshow')</option>
                                            </select>
                                        </div>
                                        <div class="col-sm-4">
                                            <label class="form-label">@lang('admin.datetime')</label>
                                            <input type="text" class="form-control" name="datetime" value="{{ date('Y-m-d H:i', strtotime($studyAbroad->datetime)) }}">
                                        </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-xxl-9 col-sm-8">
                                                                ...
                                                                <div class="col-md-5">
                                                                    <img src="{{ asset('uploads/studyAbroads/'.$studyAbroad->image) }}" style="width: 288px;!important;">
                                                                </div>
                                                            </div>
