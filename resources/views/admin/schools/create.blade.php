                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <select class="form-control" name="category_id" id="category_id">
                                                ...
                                                @foreach($categories as $category)
                                                    <option value="{{$category->id}}">{{ !empty($category['title'][$currentLang])? $category['title'][$currentLang]: null }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <select class="form-control" name="teacher_id" id="teacher_id">
                                                ...
                                                @foreach($teachers as $teacher)
                                                    <option value="{{$teacher->id}}">{{ !empty($teacher['name'][$currentLang])? $teacher['name'][$currentLang]: null }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-md-12">
                                            ...
                                            <select class="form-control" name="language_id" id="language_id">
                                                ...
                                                @foreach($mainLanguages as $language)
                                                    <option value="{{$language->id}}">{{ !empty($language['name'][$currentLang])? $language['name'][$currentLang]: null }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-md-12" id="languages-wrapper">
