...
@section('admin.content')
    ...
    <div class="main-content">
        <div class="dashboard-breadcrumb mb-25">
            <h2>@lang('admin.schools')</h2>
            @can('schools-create')
            <a class="btn btn-sm btn-primary" href="{{ route('admin.schools.create') }}">
            ...
            <div class="col-12">
                <div class="panel">
                    <div class="panel-body">
                        <div class="row">
                            @if(!empty($schools[0]) && isset($schools[0]))
                                    ...
                                    <div class="col-sm-6">
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                @can('schools-edit')
                                                <a href="{{ route('admin.schools.edit',$data['id']) }}" class="btn btn-sm btn-icon btn-primary" title="@lang('admin.edit')">
                                            ...
                                            <div class="card-body animation-card">
                                                <div class="text-center" data-aos="flip-left">
                                                    <img src="{{ asset('uploads/schools/'.$data->image) }}" alt="{{ !empty($data['name']['az'])? $data['name']['az']: $data['name']['az'] }}" style="max-height: 327px;!important;">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="modal fade" id="delete{{$value['id']}}" tabindex="-1" aria-labelledby="deletecategory{{$value['id']}}Label" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('admin.schools.destroy',$value['id']) }}" method="POST">
                            @csrf
                            @method('DELETE')
