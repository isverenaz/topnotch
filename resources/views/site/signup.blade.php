                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="contact-form">
                            ...
                            <div class="form-wrapper">
                                ...
                                <!-- Single Form Start -->
                                <div class="single-form">
                                    <input type="email" name="email" placeholder="E-poçt ünvanı">
                                </div>
                                <!-- Single Form End -->
                                <div class="single-form">
                                    <input type="email" name="email" placeholder="E-poçt ünvanı">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="contact-form">
                            <div class="form-wrapper">
                                <div class="single-form">
                                    <input type="text" name="name" placeholder="Soyadınız">
                                </div>
                                <!-- Single Form End -->
                                <!-- Single Form Start -->
                                <div class="single-form">
                                    <input type="text" name="phone" placeholder="Əlaqə nömrəniz">
                                </div>
                                <!-- Single Form End -->
                                <div class="single-form">
                                    <input type="text" name="phone" placeholder="Əlaqə nömrəniz">
                                ...
                                <!-- Single Form Start -->
                                <div class="single-form">
                                    <button class="btn btn-primary btn-hover-dark w-100">Qoşul <i class="flaticon-right"></i></button>
                                </div>
                            </div>
                        </div>
                        <!-- Contact Form End -->
