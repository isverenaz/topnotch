            ...
            <div class="page-banner-content">
                <ul class="breadcrumb">
                    ...
                    @if(!empty($schoolCategory))
                        <li >{{$schoolCategory['title'][$currentLang]}}</li>
                    @endif
                   @if(!empty($school))
                        <li  class="active" >{{$school['name'][$currentLang]}}</li>
                    @endif
                </ul>
                <h2 class="title">{{$school['text'][$currentLang] ?? ''}}</h2>
            </div>
            <!-- Page Banner End -->
        </div>
                    ...
                    <div class="courses-details">
                        @if(!empty($school['image']))
                            <div class="courses-details-images">
                                <img style="width: 60%;!important;" src="{{ asset("uploads/schools/".$school['image']) }}" alt="{{$school['name'][$currentLang]}}">
                                <span class="tags">@lang('site.schools')</span>
                            </div>
                        @endif
                        <h2 class="title">{{$school['name'][$currentLang] ?? ''}}</h2>

                        <div class="courses-details-admin">
                            <div class="admin-author">
                                @if(!empty($school['teacher']['image']))
                                    <div class="author-thumb">
                                        <a href="#"><img src="{{ asset("uploads/teachers/".$school['teacher']['image']) }}" alt="{{ $school['teacher']['name'][$currentLang] }}"></a>
                                    </div>
                                @endif
                                <div class="author-content">
                                    <a class="name">{{ $school['teacher']['name'][$currentLang] }}</a>
                                    <span class="Enroll"><i class="icofont-eye"></i>{{$school['read'] ?? 0}}</span>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="tab-pane fade show active" id="description">
                                        ...
                                        <div class="tab-description">
                                            <div class="description-wrapper">
                                                @php
                                                    $content = $school['full_text'][$currentLang] ?? '';
                ...
                <div class="col-lg-4">
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar-widget widget-information">
                            <div class="info-list">
                                <ul>
                                    <li><i class="icofont-man-in-glasses"></i> <strong>@lang('site.country')</strong> <span> {{$school['country']['name'][$currentLang]}}</span></li>
                                    <li><i class="icofont-man-in-glasses"></i> <strong>@lang('site.teacher')</strong> <span> {{$school['teacher']['name'][$currentLang]}}</span></li>
                                    <li><i class="icofont-man-in-glasses"></i> <strong>@lang('site.language')</strong> <span> {{$school['language']['name'][$currentLang]}}</span></li>
                                    <li><i class="icofont-man-in-glasses"></i> <strong>@lang('site.leve')</strong><span style="font-size: 13px;!important;">{{$school['leve']['name'][$currentLang]}}</span></li>
