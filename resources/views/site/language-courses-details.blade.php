    ...
    <div class="section page-banner">
        ...
        <div class="container">
            ...
            <div class="page-banner-content">
                ...
                <h2 class="title">{{$languageCourse['text'][$currentLang] ?? ''}}</h2>
            </div>
            <!-- Page Banner End -->
        </div>
            ...
            <div class="row gx-10">
                <div class="col-lg-8">
                    ...
                    <div class="courses-details">
                        @if(!empty($languageCourse['image']))
                        <div class="courses-details-images">
                            <img src="{{ asset("uploads/languageCourses/".$languageCourse['image']) }}" alt="{{$languageCourse['name'][$currentLang]}}">
                            <span class="tags">@lang('site.language_courses')</span>
                        </div>
                        @endif
                        <h2 class="title">{{$languageCourse['name'][$currentLang] ?? ''}}</h2>
                                    ...
                                    <div class="tab-pane fade show active" id="description">
                                        ...
                                        <div class="tab-description">
                                            <div class="description-wrapper">
                                                @php
                                                    $content = $languageCourse['full_text'][$currentLang] ?? '';
                ...
                <div class="col-lg-4">
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar-widget widget-information">
                            <div class="info-list">
                                <ul>
                                    <li><i class="icofont-man-in-glasses"></i> <strong>@lang('site.language')</strong> <span> {{$languageCourse['language']['name'][$currentLang]}}</span></li>
