...
@section('site.meta_description')
    {{ __('site.conditions_text') }}
@endsection

@section('site.meta_keywords')
    {{ implode(', ', array_filter([__('site.conditions_title'), __('site.conditions_text')])) }}
@endsection
        ...
        <div class="container">
            ...
            <div class="page-banner-content">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Şərtlər</li>
                </ul>
                <h2 class="title">Bizi şərtlərimiz ilə daha yaxından tanış olun!</h2>
            </div>
            <!-- Page Banner End -->
        </div>
